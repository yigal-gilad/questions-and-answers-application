...
class ProjectCard extends LitElement {
  ...
  <input type="text" id="myInput" value="${this.input}" @input=${e => { this.input = e.target.value }} class="form-control" placeholder="Ask your question here...">
...
<button type="button"
 class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal" @click="${e => { this.selectedQuestion = item.payload.question }}">
  Answer
</button>
